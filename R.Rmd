...
a <- lm(log10(tree_height)~annual_precip*wind_speed,data=df2)
b <- lm(log10(tree_height)~annual_precip+wind_speed,data=df2)
c <- lm(log10(tree_height)~wind_speed,data=df2)
d <- lm(log10(tree_height)~annual_precip,data=df2)
