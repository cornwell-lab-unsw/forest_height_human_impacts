...
We then completed an Akaike's An Information Criterion on each of the quantile regression.
```{r}
AIC(p_rq)
```
...
Then we plotted the difference between the predicted map and the actual map over the growth rate map. 
```{r}
